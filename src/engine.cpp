...
void Engine::createTextureImage() {
    ...
    stbi_uc* pixels = stbi_load("../res/set.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
VkFormat Engine::findDepthFormat() {
    return findSupportedFormat(
        { VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT }, // options for depth format
...
void Engine::recordCommandBuffer(VkCommandBuffer commandBuffer,
    ...
    vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(input_indices.size()), 1, 0, 0, 0);
